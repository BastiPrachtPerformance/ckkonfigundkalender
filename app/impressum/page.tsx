...
export default function ImprintPage() {
  return <LegalPage eyebrow="Rechtliches / 01" title="Impressum">
    <section><h2>Angaben gemäß § 5 TMG</h2><p>CK Eventcenter<br />Industriestraße 44a<br />59192 Bergkamen</p></section>
    <section><h2>Vertreten durch</h2><p>Inhaber: Cevat Demircan</p><p>E-Mail: <a href="mailto:info@ckeventcenter.de">info@ckeventcenter.de</a><br />Website: www.ckeventcenter.de</p></section>
