...
export default function PrivacyPage() {
  return <LegalPage eyebrow="Rechtliches / 02" title="Datenschutz">
    <section><h2>Allgemeiner Hinweis</h2><p>Eine Datenschutzerklärung beschreibt, welche personenbezogenen Daten eine Internetseite erhebt, wie und warum sie verarbeitet werden, ob eine Weitergabe an Dritte erfolgt und welche Rechte Besucherinnen und Besucher haben.</p></section>
    ...
    <aside><strong>Wichtiger Hinweis</strong><p>Die bisherige Internetseite enthielt lediglich einen allgemeinen Wix-Mustertext. Vor der endgültigen Veröffentlichung sollte diese Datenschutzerklärung anhand aller tatsächlich eingesetzten Dienste rechtlich geprüft und vervollständigt werden.</p></aside>
  </LegalPage>;
}
