...
export default function TermsPage() {
  return <LegalPage eyebrow="Rechtliches / 03" title="Allgemeine Geschäftsbedingungen">
    ...
    <aside><strong>Wichtiger Hinweis</strong><p>Die bisherige Internetseite enthielt einen allgemeinen Wix-Mustertext und keine individuell ausgearbeiteten Geschäftsbedingungen. Dieser Bereich muss vor der endgültigen Veröffentlichung rechtlich vervollständigt werden.</p></aside>
  </LegalPage>;
}
